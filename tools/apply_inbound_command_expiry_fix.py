...
d = doc.read_text()
old = '''regularly from the application loop so request timeouts and bounded reassembly/duplicate caches can expire even while no packets are arriving.\n'''
